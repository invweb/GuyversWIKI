...
import com.zx_tole.guyverwiki.databinding.GuyverItemBinding
import com.zx_tole.guyverwiki.tech.CHARACTER

class GuyversAdapter : RecyclerView.Adapter<GuyversAdapter.CharactersViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CharactersViewHolder {
        ...
        val binding = GuyverItemBinding.inflate(inflater)
    ...
    inner class CharactersViewHolder(itemBinding: GuyverItemBinding) : RecyclerView.ViewHolder(itemBinding.root),
